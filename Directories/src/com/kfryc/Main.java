...
//        Path directory = FileSystems.getDefault().getPath("FileTree\\Dir2");
        ...
        // Copying whole directory tree with files
        ...
        // Small hack to use the java.io working directory (generally java.nio is better)
