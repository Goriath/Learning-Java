    ...
    public boolean addItem(ListItem newItem) {
        ...
        while (currentItem!= null){
            ...
            if(comparison <0){
                ...
                //equal, do not add anything as we do not want duplicates
                System.out.println(newItem.getValue() + " is already present");
                return false;
            }
        }
        //we cannot get to this line but Java compiler complains if it is no return value.
